...
python3 train_zeroshot.py -tw 1 -td 40 -sw 1 -sd 16 -twgt ~/cifar10_WRN-40-1-seed45_model.165.h5 --seed 45
python3 train_zeroshot.py -tw 1 -td 40 -sw 2 -sd 16 -twgt ~/cifar10_WRN-40-1-seed45_model.165.h5 --seed 45
