...
if __name__ == '__main__':
    ...
    ax.set_xlabel("Adversarial steps")
    ax.set_ylabel("Probability to match other classes")
    plt.savefig('renormal_fewshot.pdf', bbox_inches='tight')
    # =============================================================
    # Zero shot
    zero_df.rename(columns={'student': 'zeroshot'}, inplace=True)
    ax = zero_df.plot()
    ax.set_ylim(0, 1.1)
    ax.set_xlim(0, 30)
    ax.set_ylabel("Probability to match other classes")
    ax.set_xlabel("Adversarial steps")
    plt.savefig('zeroshot.pdf',bbox_inches='tight')
    # normalized
    ...
    ax.set_xlabel("Adversarial steps")
    ax.set_ylabel("Probability to match other classes")
    plt.savefig('renormal_zeroshot.pdf', bbox_inches='tight')
    # =============================================================
    # Normal KD
    normalkd_df.rename(columns={'student': 'Normal KD'}, inplace=True)
    ax = normalkd_df.plot()
    ax.set_ylim(0, 1.1)
    ax.set_xlim(0, 30)
    ax.set_ylabel("Probability to match other classes")
    ax.set_xlabel("Adversarial steps")
    plt.savefig('normalkd.pdf', bbox_inches='tight')
    # normalized
    ...
    ax.set_xlabel("Adversarial steps")
    ax.set_ylabel("Probability to match other classes")
    plt.savefig('renormal_normalkd.pdf', bbox_inches='tight')
    # =============================================================
